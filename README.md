...
Go to [localhost](https://127.0.0.1:8888) to open the jupyter interface. The example notebook is [here](https://github.com/cms-jet/CoffeaJERC/blob/master/genL2L3.ipynb). 
